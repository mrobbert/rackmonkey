...
(
	...
	size INTEGER,
	position_sequence CHAR NOT NULL DEFAULT '1',
	number_from_bottom INTEGER NOT NULL DEFAULT 1,
	notes CHAR,
	meta_default_data INTEGER NOT NULL DEFAULT 0,
	meta_update_time CHAR,
	meta_update_user CHAR
...
(
	...
	service_device INTEGER NOT NULL
		CONSTRAINT fk_service_id REFERENCES service(id),
	service_customer INTEGER NOT NULL
		CONSTRAINT fk_service_id REFERENCES service(id),	
...
(
	...
	name CHAR NOT NULL COLLATE NOCASE,
	max_current INTEGER,
	phase CHAR NOT NULL COLLATE NOCASE,
...
(
	...
	supply_measurement_idle_date CHAR,
	supply_voltage_typical INTEGER,
	supply_current_typical INTEGER,
	supply_realpower_typical INTEGER,
	supply_measurement_typical_date CHAR,
...
(
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	net_number CHAR NOT NULL COLLATE NOCASE,
	net_mask INTEGER NOT NULL,
	net_version INTEGER NOT NULL,
	gateway CHAR NOT NULL COLLATE NOCASE,
	name CHAR NOT NULL COLLATE NOCASE
);
...
(
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	address CHAR NOT NULL COLLATE NOCASE,
	network INTEGER NOT NULL
		CONSTRAINT fk_network_id REFERENCES network(id),
	net_version INTEGER NOT NULL
);


-- map network addresses to devices via ports, each port can have more than one address
CREATE TABLE device_net_address
(
	net_address INTEGER NOT NULL
		CONSTRAINT fk_net_address_id REFERENCES net_address(id),
	device INTEGER NOT NULL
		CONSTRAINT fk_device_id REFERENCES device(id),
	port char NOT NULL COLLATE NOCASE
);
