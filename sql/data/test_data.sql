...
-- Test Devices
-- Two switches
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('sw1', 3, 7, 20, 2, 'ABC123', 'CH1001', '2004-02-29', 11, '12', 28, 2, 21, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('sw2', 3, 8, 20, 2, 'ABC124', 'CH1002', '2004-02-29', 11, '12', 28, 2, 21, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Two database servers
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('db1', 4, 7, 2, 5, 8388608, 'T1234', '', '2009-01-01', 17, '4', 29, 4, 8, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('db2', 4, 8, 2, 5, 8388608, 'T1235', '', '2009-01-14', 17, '4', 29, 4, 8, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Two monitoring servers
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('mon1', 3, 7, 17, 4, 'ABC125', 'CH1003', '2008-11-01', 8, '6', 28, 2, 16, 0, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('mon2', 3, 8, 17, 4, 'ABC126', 'CH1004', '2008-11-01', 8, '6', 28, 2, 16, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Four web servers
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www1', 4, 7, 5, 3, 2097152, 'T4567', '', '2005-06-24', 21, '8.04', 29, 4, 24, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www2', 4, 8, 5, 3, 2097152, 'T4568', '', '2005-06-24', 21, '8.04', 29, 4, 24, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www4', 4, 8, 7, 3, 786432, 'T4570', '', '2005-06-24', 21, '8.04', 29, 4, 24, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www3', 4, 7, 7, 3, 1048576, 'T4569', '', '2005-06-24', 21, '8.04', 29, 4, 24, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Three app servers
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, os_kernel, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('app1', 4, 7, 10, 7, 33554432, 'T9909', '', '2007-09-24', 19, '10', '139555-08', 29, 4, 3, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, ram_installed, serial_no, asset_no, purchased, os, os_version, os_kernel, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('app2', 4, 8, 10, 7, 33554432, 'T9910', '', '2007-10-24', 19, '10', '139555-08', 29, 4, 3, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('appdev', 4, 8, 12, 7, 'T9998', '', '2007-04-24', 16, '2008.11', 29, 4, 3, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Windows fileserver, includes OS licence key
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, os_licence_key, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('winfs', 5, 7, 12, 4, 'T9909', '', '2007-09-24', 24, '2003', 'AAAAA-BBBBB-CCCCC-DDDDD-EEEEE', 29, 4, 12, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
...
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('panel1', 3, 7, 40, 9, 'ZBC123', 'PA1001', '2004-02-29', 11, '12', 28, 2, 21, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('panel2', 3, 8, 40, 9, 'ZBC124', 'PA1002', '2004-02-29', 11, '12', 28, 2, 21, 1, 'Test data', 0, '1988-02-15 00:00:00', 'rackmonkey');
