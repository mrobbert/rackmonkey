...
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('db1', 4, 11, 2, 5, 'T1234', '', '2007-09-05', 18, '10', 27, 4, 8, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('db2', 4, 12, 2, 5, 'T1235', '', '2007-09-05', 18, '10', 27, 4, 8, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- One monitoring server
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('mon', 3, 11, 17, 4, 'ABC125', 'CH1003', '2005-03-01', 7, '6', 26, 2, 16, NULL, 0, '', 0, '1988-02-15 00:00:00', 'rackmonkey');

-- Four web servers
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www1', 4, 11, 7, 3, 'T4567', '', '2007-06-24', 18, '10', 27, 4, 24, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www2', 4, 12, 7, 3, 'T4568', '', '2007-06-24', 18, '10', 27, 4, 24, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www4', 4, 12, 10, 3, 'T4570', '', '2007-06-24', 18, '10', 27, 4, 24, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');
INSERT INTO device (name, domain, rack, rack_pos, hardware, serial_no, asset_no, purchased, os, os_version, customer, service, role, monitored, in_service, notes, meta_default_data, meta_update_time, meta_update_user) VALUES ('www3', 4, 11, 10, 3, 'T4569', '', '2007-06-24', 18, '10', 27, 4, 24, NULL, 1, '', 0, '1988-02-15 00:00:00', 'rackmonkey');
